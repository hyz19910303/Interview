...
/**
 * Create at 2018年8月30日 上午11:04:07
 *
 * @autuor huyz
 *
 * @version 1.0
...
public class ReturnTypeResolver {
	...
	public static Class<?> returnType(Class<?> mapperInterface, Method method) {
		Type resolvedReturnType = resolveReturnType(method, mapperInterface);
		...
		// ReturnTypeResolver.returnsVoid =
		// void.class.equals(ReturnTypeResolver.returnType);
...
//		this.paramNameResolver = new ParamNameResolver(configuration, method);
	...
	public static boolean returnsVoid(Class<?> mapperInterface, Method method) {
		return void.class.equals(returnType(mapperInterface, method));
	}
